// AcessarConta — Tela intermediária pós-checkout (acesso por email + senha).
//
// Fluxo (pós-decisão de remover Google):
//   /checkout/sucesso → CTA "Continuar" → /acessar-conta?email=...&plan=...
//   → mostra status do envio do email de criação de senha (disparado pelo webhook
//     do Asaas) e CTA secundário "Reenviar link" / "Já tenho senha — entrar".
//
// Toda a comunicação fica em PT-BR e na identidade O CORTE.
...
// Observabilidade silenciosa (usuário ainda não está logado — 401 é ignorado).
...
export default function AcessarConta() {
  ...
  // Dispara envio do email "criar senha".
  ...
  useEffect(() => {
    recordAccessEvent('first_access_started', { has_email: !!email, action: action || null });
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-14 animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-500 max-w-md mx-auto">
            Enviamos um email para você criar sua senha. Em segundos você acessa o painel da sua barbearia.
          </p>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[13px] text-emerald-900/80 mt-1 leading-relaxed">
                  Enviamos um email para <strong className="break-all">{email}</strong> com o link para criar sua senha. Abra o email e clique no botão "Criar minha senha".
                </p>
        ...
        <div className="space-y-2.5">
          <PrimaryAction
            ...
            sublabel={resetSent ? `Reenviar para ${email}` : 'Enviaremos um link de criação de senha para seu email'}
          />
          <PrimaryAction
