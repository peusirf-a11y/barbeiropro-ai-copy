...
export default function Onboarding() {
  ...
  // Carrega a Company existente do usuário. Match por owner_email OU created_by
  // (alguns fluxos antigos deixam owner_email vazio). Também RETOMA da última
  // etapa salva (onboarding_step) — nunca volta pra etapa 1 se já tinha avançado.
  useEffect(() => {
  ...
  const finishOnboarding = async () => {
    ...
    try {
      ...
      await base44.entities.Company.update(id, {
        ...
        // Preenche owner_email se ainda estava vazio.
