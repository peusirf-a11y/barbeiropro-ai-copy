...
export default function MasterFuncionalidades() {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-black text-foreground tracking-tight">Funcionalidades</h2>
      ...
      <div>
        <h3 className="text-base font-bold text-foreground tracking-tight mb-2">Flags experimentais</h3>
