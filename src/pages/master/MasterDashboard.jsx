// Dashboard do Master — visão geral do sistema com KPIs, alertas e saúde.
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <div>
        ...
        <p className="text-sm text-[#6B7280] mt-1">Indicadores em tempo real do BarberTrimly SaaS.</p>
      </div>
      <MasterMetrics />
      <SystemAlertsList />
      <SystemHealth />
