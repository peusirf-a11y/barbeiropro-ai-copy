    ...
    return (
      <div className="flex items-center gap-3">
        <div className="relative w-10 h-10 flex items-center justify-center flex-shrink-0">
          ...
          <span className={`absolute text-[10px] font-black ${score >= 80 ? 'text-emerald-600' : score >= 55 ? 'text-amber-600' : 'text-red-600'}`}>
            {score}
          </span>
        </div>
      ...
      <div className="flex items-center gap-4 mb-4">
        <div className="relative w-20 h-20 flex items-center justify-center flex-shrink-0">
          ...
          <div className="absolute text-center">
            <div className={`text-xl font-black ${score >= 80 ? 'text-emerald-600' : score >= 55 ? 'text-amber-600' : 'text-red-600'}`}>
              {score}
            </div>
          </div>
        </div>
        <div>
          <div className="text-base font-bold text-[#111827]">Security Score</div>
          ...
          return (
            <div key={key}>
              <div className="flex items-center justify-between mb-0.5">
                ...
                <span className="text-[11px] font-bold text-gray-700">{catScore}/{maxScore}</span>
              </div>
